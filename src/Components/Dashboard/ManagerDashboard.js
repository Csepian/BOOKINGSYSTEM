...
const ManagerDashboard = () => {
  ...
  const [hotelID, setHotelID] = useState(6); // Default value if hotelID is not provided
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setHotelID(response.data.user.hotelID);
    ...
    <DashboardContainer>
      ...
      <CardGrid>
        ...
        <Card>
          ...
          <ActionButton onClick={() => navigate(`/hotel/${hotelID}`)}>
            View hotel Booking
          </ActionButton>
